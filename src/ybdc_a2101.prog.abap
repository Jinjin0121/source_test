...
*& SELECT VIEW ; POPUP
    ...
    PERFORM f_bdc_data USING :
      ...
      ' ' 'BDC_OKCODE'   '=SP04'.
        ...
        PERFORM f_bdc_data USING :
      'X' 'SAPLMGMM'     '0081',  "
      ' ' 'RMMG1-WERKS'   wa_mara-werks,
      ' ' 'RMMG1-VKORG'   wa_mara-vkorg,
      ' ' 'RMMG1-VTWEG'   wa_mara-vtweg,
      ' ' 'BDC_OKCODE'   '=ENTR'.

      PERFORM f_bdc_data USING :
      'X' 'SAPLMGMM'     '4000',  "
      ' ' 'MG03STEUER-TAXKM(01)'  wa_mara-taxkm,
      ' ' 'BDC_OKCODE'   '=SP05'.
    ...
    PERFORM f_bdc_data USING :
         'X' 'SAPLMGMM'     '4000',  "
         ' ' 'MVKE-MTPOS'  wa_mara-MTpos,
         ' ' 'BDC_OKCODE'   '=SP06'.

    PERFORM f_bdc_data USING :
      'X' 'SAPLMGMM'     '4004',  "
      ' ' 'MARC-MTVFP'  wa_mara-mtvfp,
      ' ' 'BDC_OKCODE'   '=BU'.
